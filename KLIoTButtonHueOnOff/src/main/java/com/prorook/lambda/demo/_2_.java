...
public class _2_ implements Serializable
{
    ...
    private final static long serialVersionUID = 8139621626703596591L;
    ...
    @JsonProperty("state")
    public State______ getState() {
        return state;
    }

    @JsonProperty("state")
    public void setState(State______ state) {
        this.state = state;
    }
