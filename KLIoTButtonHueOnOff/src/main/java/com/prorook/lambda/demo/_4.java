...
public class _4 implements Serializable
{
    ...
    private Capabilities___ capabilities;
    @JsonProperty("config")
    ...
    private final static long serialVersionUID = 1723680305003390543L;
    ...
    @JsonProperty("swupdate")
    public Swupdate___ getSwupdate() {
        return swupdate;
    }

    @JsonProperty("swupdate")
    public void setSwupdate(Swupdate___ swupdate) {
    ...
    @JsonProperty("capabilities")
    public Capabilities___ getCapabilities() {
        return capabilities;
    }

    @JsonProperty("capabilities")
    public void setCapabilities(Capabilities___ capabilities) {
