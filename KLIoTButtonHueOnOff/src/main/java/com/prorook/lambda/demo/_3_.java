...
public class _3_ implements Serializable
{
    ...
    private final static long serialVersionUID = 4513895456413108388L;
    ...
    @JsonProperty("state")
    public State_______ getState() {
        return state;
    }

    @JsonProperty("state")
    public void setState(State_______ state) {
        this.state = state;
    }
