...
public class _3__ implements Serializable
{
    ...
    private List<Condition__> conditions = new ArrayList<Condition__>();
    @JsonProperty("actions")
    private List<Action______> actions = new ArrayList<Action______>();
    @JsonIgnore
    private Map<String, Object> additionalProperties = new HashMap<String, Object>();
    private final static long serialVersionUID = 3814608546255505130L;
    ...
    @JsonProperty("actions")
    public List<Action______> getActions() {
        return actions;
    }

    @JsonProperty("actions")
    public void setActions(List<Action______> actions) {
