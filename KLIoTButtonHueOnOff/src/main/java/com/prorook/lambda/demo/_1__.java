...
public class _1__ implements Serializable
{
    ...
    private List<Action____> actions = new ArrayList<Action____>();
    @JsonIgnore
    private Map<String, Object> additionalProperties = new HashMap<String, Object>();
    private final static long serialVersionUID = 6940281314253022245L;
    ...
    @JsonProperty("actions")
    public List<Action____> getActions() {
        return actions;
    }

    @JsonProperty("actions")
    public void setActions(List<Action____> actions) {
